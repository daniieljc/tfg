    ...
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner">
            ...
            <div class="dashboard-headline">
                <h3>{{ __('home.menu.usuarios') }}</h3>

                <!-- Breadcrumbs -->
                <nav id="breadcrumbs" class="dark">
                    <ul>
                        <li><a href="#">{{ __('home.menu.tablero') }}</a></li>
                        <li>{{ __('home.menu.usuarios') }}</li>
                    </ul>
                </nav>
            </div>
                                            ...
                                            <td>
                                                @if ($item->role == 1)
                                                    <a class="button dark ripple-effect" style="color: white"
                                                        href="{{ route('teacher.usuario.editar1', ['id' => $item->id]) }}"><i
                                                            class="icon-feather-edit"></i></a>
                                                @elseif($item->role == 2)
                                                    <a class="button dark ripple-effect" style="color: white"
                                                        href="{{ route('teacher.usuario.editar2', ['id' => $item->id]) }}"><i
                                                            class="icon-feather-edit"></i></a>
                                                @else
                                                    <a class="button dark ripple-effect" style="color: white"
                                                        href="{{ route('teacher.usuario.editar3', ['id' => $item->id]) }}"><i
                                                            class="icon-feather-edit"></i></a>
                                                @endif

                                                <a class="button red ripple-effect" style="color: white"
                                                    href="{{ route('teacher.usuario.eliminar', ['id' => $item->id]) }}"><i
