...
@section('content')
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner">
            ...
            <form action="{{ route('teacher.usuario.guardar2') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="submit-field">
                                                    ...
                                                    <input type="text" class="with-border" value="{{ $user->ident_fis }}"
